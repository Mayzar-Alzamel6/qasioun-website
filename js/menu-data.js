...
window.MENU = [
  ...
  {
    id: 'pastries', title: 'المعجنات', img: 'assets/img/menu/pastries.webp', icon: 'croissant',
    items: [
  ...
  {
    id: 'sandwiches', title: 'السندويشات', img: 'assets/img/menu/sandwiches.webp', icon: 'sandwich',
    cols: ['عادي', 'صاج'],
    sizePrefix: 'خبز ',
    orderPrefix: 'ساندويش ',
    items: [
  ...
  {
    id: 'starters', title: 'المقبلات', img: 'assets/img/menu/starters.webp', icon: 'salad',
    items: [
  ...
  {
    id: 'sweets', title: 'الحلويات', img: 'assets/img/menu/sweets.webp', icon: 'cake',
    items: [
  ...
  {
    id: 'hot', title: 'المشروبات الساخنة', img: 'assets/img/menu/hot.webp', icon: 'coffee',
    items: [
  ...
  {
    id: 'cold', title: 'المشروبات الباردة', img: 'assets/img/menu/cold.webp', icon: 'cup',
    cols: ['صغير', 'كبير'],
    items: [
